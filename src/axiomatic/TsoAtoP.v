...
Proof.
  ...
  - (* read *)
    ...
    + generalize READ_STEP. intro X. inv X.
      ...
      intro Y. inv Y.
      instantiate (1 := eloc) in VAL0. rewrite READ in MSG0. inv MSG0.
      econs; ss. econs; ss.
      * (* sim_local coh *)
  ...
  - (* write *)
    ...
    instantiate (1 := eval). intro X. inv X.
    eexists (ExecUnit.mk _ _ _). esplits.
    + econs. econs; ss.
      { econs; ss. }
      econs 3; ss.
